...
public class H2_Save {
	...
	public static void main(String[] args) {
		...
		Configuration con=new Configuration(). //cfg.xml dosyasinda ki bilgiler ile mysql e baglan	
				configure("hibernate.cfg.xml").
				addAnnotatedClass(H1_Sehir.class); //kalip class imizi buraya cagir
		
	SessionFactory sf=con.buildSessionFactory(); //acacagimiz alanlarin parent i, alan fabrikasi
