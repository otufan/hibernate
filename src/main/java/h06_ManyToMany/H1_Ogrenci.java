...
public class H1_Ogrenci {
	...
	//manytomany = ogrencilerden -> kutuphane kitaplarina
	...
	@JoinTable(name="H1_Ogrenci_H2_Kitap",
	           joinColumns= {@JoinColumn(name="ogrencci")},
...
ve kitaplar için bir liste oluşturmanız gerekir.
	...
	*/
	...
	public String toString() {
		return "Ogrenci Bilgileri [std_id=" + std_id + ", name=" + name + ", grade=" + grade + ", books=" + books + "]";
	}
